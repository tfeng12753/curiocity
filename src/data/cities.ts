  ...
  math: {
    ...
    levels: [
      ...
      },
      {
        ...
        tagline: 'Split the fuel strip into fifths and tenths for landing.',
        x: 56,
        y: 30,
        status: 'playable',
        ...
        coinReward: 50,
        learningPoints: [
          'Split wholes into fifths and tenths',
          'See why 2/10 is the same amount as 1/5',
          'Cut a shape twice as fine, one more time',
        ],
      },
      {
        id: 'alien-2',
